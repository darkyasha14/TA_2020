 ...
 */
public class UsernameModal extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.username_modal, container, false);
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (jsonObject.getString("code").equals("0")) {
                            ...
                            editNama.setText(jsonObject2.getString("username"));

                            btnSaveName.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    try {
                                        updateData(jsonObject2.getString("email"), jsonObject2.getString("name"), jsonObject2.getString("password"));
    ...
    private void updateData(String email, String name, String password) {
