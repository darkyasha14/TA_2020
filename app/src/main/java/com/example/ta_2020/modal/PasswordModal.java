 ...
 */
public class PasswordModal extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.password_modal, container, false);
                        ...
                        if (jsonObject.getString("code").equals("0")) {
                            ...
                            btnSaveName.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    try {
                                        updateData(jsonObject2.getString("email"), jsonObject2.getString("username"), jsonObject2.getString("name"));
    ...
    private void updateData(String email, String username, String name) {
